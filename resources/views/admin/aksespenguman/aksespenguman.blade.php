  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Daftar Penguman</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="{{('/data-penguman/create')}}" class="btn btn-primary">Tambah Penguman</a>
              <br>
              <br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$data->judul_penguman}}</td>
                  <td>{{$data->isi_penguman}}</td>
                  <td>
                    <a class="btn btn-warning" href="{{url('/data-penguman')}}/{{$data->id}}/edit"><i class="fa fa-edit"></i></a>
                    <a class="btn btn-danger" href="{{ url('/data-penguman') }}/{{$data->id}}" onclick="event.preventDefault();document.getElementById('form{{$data->id}}').submit();"><i class="fa fa-trash">
                    <form id="form{{$data->id}}" action="{{ url('/data-penguman') }}/{{$data->id}}" method="POST" style="display: none;">
