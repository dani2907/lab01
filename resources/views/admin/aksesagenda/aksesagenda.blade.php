      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="{{('/data-agenda/create')}}" class="btn btn-primary">Tambah Agenda</a>
              <br>
              <br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a class="btn btn-warning" href="{{url('/data-agenda')}}/{{$data->id}}/edit"><i class="fa fa-edit"></i></a>
                    <a class="btn btn-danger" href="{{ url('/data-agenda') }}/{{$data->id}}" onclick="event.preventDefault();document.getElementById('form{{$data->id}}').submit();"><i class="fa fa-trash">
                    <form id="form{{$data->id}}" action="{{ url('/data-agenda') }}/{{$data->id}}" method="POST" style="display: none;">
